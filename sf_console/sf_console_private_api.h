 ...
 **********************************************************************************************************************/
fsp_err_t SF_CONSOLE_Open(sf_console_ctrl_t      * const p_ctrl,
                          sf_console_cfg_t const * const p_cfg );
fsp_err_t SF_CONSOLE_Close(sf_console_ctrl_t     * const p_ctrl);
fsp_err_t SF_CONSOLE_Prompt(sf_console_ctrl_t       * const p_ctrl,
                            sf_console_menu_t const * const p_menu,
                            UINT                       const timeout);
fsp_err_t SF_CONSOLE_Parse(sf_console_ctrl_t        * const p_ctrl,
                           sf_console_menu_t  const * const p_cmd_list,
                           uint8_t            const * const p_input,
                           uint32_t                   const bytes);
fsp_err_t SF_CONSOLE_Read(sf_console_ctrl_t * const p_ctrl,
                          uint8_t           * const p_dest,
                          uint32_t            const bytes,
                          uint32_t            const timeout);
fsp_err_t SF_CONSOLE_Write(sf_console_ctrl_t * const p_ctrl,
                           uint8_t     const * const p_src,
                           uint32_t            const timeout);
fsp_err_t SF_CONSOLE_ArgumentFind(uint8_t const * const p_arg,
